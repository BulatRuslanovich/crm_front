  ...
  return (
    <div className="w-full flex justify-center items-center">
      <motion.nav
        ...
        className={`fixed z-50 rounded-full  border  border-red-300/20 bg-background/15 backdrop-blur-sm   shadow-lg `}
      >
            ...
            {isHome &&
              navLinks.map((link) => (
                ...
                >
                  {link.name}
                  <motion.span
                    className="absolute bottom-1 left-3 right-3 h-0.5 bg-primary scale-x-0 group-hover:scale-x-100 origin-left transition-transform"
                    initial={{ scaleX: 0 }}
                    whileHover={{ scaleX: 1 }}
