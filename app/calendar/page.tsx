...
export default function CalendarPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status.toLowerCase()) {
      case 'запланирован':
        return '#2563eb'; // более яркий синий
      case 'открыт':
        return '#16a34a'; // более яркий зеленый
      case 'сохранен':
        return '#ea580c'; // более яркий оранжевый
      case 'закрыт':
        return '#6b7280'; // красный для закрытых
      default:
        return '#6b7280'; // серый
    }
  };
              ...
              <div className='flex items-center justify-between mb-4'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <button
                    ...
                    style={{
                      background:
                        view === Views.DAY ? 'var(--primary)' : 'var(--muted)',
                      color:
                        view === Views.DAY
                  ...
                  <button
                    ...
                    style={{
                      background:
                        view === Views.WEEK ? 'var(--primary)' : 'var(--muted)',
                      color:
                        view === Views.WEEK
                          ? 'var(--primary-foreground)'
                          : 'var(--foreground)',
